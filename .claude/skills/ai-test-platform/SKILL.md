...
**强制要求**：每完成一个开发阶段，必须进行复盘并记录。

### 复盘时机

1. **阶段开始时** - 回顾上一阶段的复盘文档，了解已完成工作和遇到的问题
2. **阶段完成时** - 创建当前阶段的复盘文档，记录工作内容和经验教训

### 复盘文档位置

```
docs/retrospectives/
├── phase1-hello-world.md
├── phase2-agent-workflow.md
...
在 `docs/retrospectives/README.md` 中维护所有复盘文档的索引：
...
| 阶段 | 文档 | 状态 | 关键成果 |
|------|------|------|----------|
| 1.0 | [phase1-hello-world.md](./phase1-hello-world.md) | ✅ | 基础流程搭建 |
| 2.0 | [phase2-agent-workflow.md](./phase2-agent-workflow.md) | ✅ | LangGraph 工作流 |
| 3.1 | [phase3.1-midscene-setup.md](./phase3.1-midscene-setup.md) | ✅ | Midscene 环境搭建 |
| ... | ... | ... | ... |
```
